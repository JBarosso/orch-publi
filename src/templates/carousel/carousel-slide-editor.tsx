        ...
        <div className="min-w-80 flex-1 space-y-2">
          ...
          <div className="flex items-center gap-2 rounded-md bg-muted/40 p-1.5">
            ...
            <LinkFields
              ...
              cidPlaceholder="ex: landing-x"
            />
          </div>

          {/* callout.side sert aussi d'alignement global de la diapositive
              (attribut data-align à l'export), même quand le callout produit
              est désactivé — d'où ce select hors du bloc callout. */}
          <div className="flex items-center gap-2 rounded-md bg-muted/40 p-1.5">
            <span
              className="text-[10px] text-muted-foreground shrink-0"

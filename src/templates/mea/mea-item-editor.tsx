  ...
  return (
    <>
        ...
        <div className="flex min-w-0 flex-1 flex-wrap items-start gap-3">
          ...
          <div className="min-w-80 flex-1 space-y-2">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              >
                <SelectTrigger className="h-8 w-27.5 shrink-0 text-xs">
              ...
              {(item.overlayType === "label" || item.overlayType === "text") && (
                <Input
                  ...
                  className="h-8 min-w-45 flex-1 text-xs"
                />
              )}
            </div>
      ...
      <ConfirmDeleteDialog
        ...
        title="Supprimer cette MEA ?"
        description="Cette action est irréversible. La MEA sera définitivement supprimée."
        onConfirm={onRemove}
      />
    </>
  );
